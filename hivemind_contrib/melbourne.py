...
def add_project_members_to_sut_role(project):
    ...
    """
    keystone.add_project_all_users_roles(project, ['PreProdUser', 'SUT-Access'])
...
def remove_project_members_from_sut_role(project):
    ...
    """
    keystone.remove_project_all_users_roles(project, ['PreProdUser', 'SUT-Access'])
...
def add_project_members_to_uom_role(project):
    ...
    """
    keystone.add_project_all_users_roles(project, ['PreProdUser', 'UoM-Access'])
...
def remove_project_members_from_uom_role(project):
    ...
    """
    keystone.remove_project_all_users_roles(project, ['PreProdUser', 'UoM-Access'])
