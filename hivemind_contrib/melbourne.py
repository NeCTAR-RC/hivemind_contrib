...
def add_sut_role_to_user(project, user):
    ...
    """
    keystone.add_project_roles(project, user,
                               ['PreProdUser', 'SUT-Access'])
...
def remove_sut_role_from_user(project, user):
    ...
    """
    keystone.remove_project_roles(project, user,
                                  ['PreProdUser', 'SUT-Access'])
...
def add_project_members_to_sut_role(project):
    ...
    """
    keystone.add_project_all_users_roles(project,
                                         ['PreProdUser', 'SUT-Access'])
...
def remove_project_members_from_sut_role(project):
    ...
    """
    keystone.remove_project_all_users_roles(project,
                                            ['PreProdUser', 'SUT-Access'])
