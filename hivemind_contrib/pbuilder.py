...
MIRRORS_REPO = 'http://mirrors.melbourne.nectar.org.au/ubuntu-cloud/ubuntu/'
CLOUD_ARCHIVE = 'http://mirrors.melbourne.nectar.org.au/ubuntu-archive/ubuntu/'
...
mirrors = {
    'grizzly': ["deb " + MIRRORS_REPO + " precise-updates/grizzly main",
                ...
                "deb " + CLOUD_ARCHIVE + " precise-updates main universe"],
    'havana': ["deb " + MIRRORS_REPO + " precise-updates/havana main",
               "deb " + NECTAR_REPO + " precise main",
    ...
    'icehouse': [
        ...
        "deb " + MIRRORS_REPO + " trusty-updates main universe"],
}
