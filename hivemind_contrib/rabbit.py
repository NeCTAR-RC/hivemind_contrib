...
# This requires a config file in ~/.hivemind/hivemind/config.ini that looks
# something like (with environment_name either prod or test or melb etc):
#
# [rabbitmq.management.environment_name]
# host =
# username =
# password =
#
