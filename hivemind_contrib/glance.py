...
def get_real_tenant(tenant, community=False, archive=False):
    """fetch tenant id from config file"""
    if community:
        if archive:
            tenant_type = 'communityarchivetenant'
        else:
            tenant_type = 'communitytenant'
    else:
        tenant_type = 'archivetenant'
