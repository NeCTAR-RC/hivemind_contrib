...
def get_community_archive_tenant(tenant=None):
    ...
    msg = " ".join(("No community archive tenant set.", "Please set tenant in",
...
def archive(image_id, dry_run=True, tenant=None, community=False):
    ...
    If the community flag is set please specify the community archive tenant id.
    """
    if dry_run:
        print("Running in dry run mode")
