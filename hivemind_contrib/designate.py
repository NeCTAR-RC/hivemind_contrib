...
@decorators.configurable('creds')
def client(version='2', sudo_project_id=None, username=None, password=None,
           project_name=None, auth_url=None):
    sess = keystone.get_session(username, password, project_name, auth_url, use_env=False)
